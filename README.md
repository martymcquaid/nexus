...
- **Dev Server URL**: `http://127.0.0.1:5236`
- **Preview URL**: `https://api.chitterchat.co.uk/chipify/projects/4039aba9-078c-4174-90fa-6ac4639a9493/preview`
- **Port**: `5236`
...
4. The dev server is accessible at `http://127.0.0.1:5236`
5. Preview the application using the preview URL: `https://api.chitterchat.co.uk/chipify/projects/4039aba9-078c-4174-90fa-6ac4639a9493/preview`
